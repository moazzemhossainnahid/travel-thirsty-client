...
const HotelSidebar = ({ handleSearchFiltering, handleFilterNum }) => {
  return (
          ...
          <div className="flex items-center">
            <form className="w-full space-y-5">
              ...
              >
                ...
                <option value="Luxury Hotel in Paris">
                  Luxury Hotel in Paris
                </option>
                <option value="5 star Hotel">5 star Hotel</option>
                <option value="Cox's bazar 3 start hotel">
                  Cox's bazar 3 start hotel
                </option>
                <option value="Luxury Hotel in AUS">Luxury Hotel in AUS</option>
                <option value="Luxury Hotel in London">
                  Luxury Hotel in London
                </option>
                <option value="Hotel in UK">Hotel in UK</option>
                <option value="Luxury Hotel in Dhaka">
                  Luxury Hotel in Dhaka
                </option>
                <option value="Luxury Hotel in IND">Luxury Hotel in IND</option>
                <option value="Luxury Hotel in USA">Luxury Hotel in USA</option>
              </select>
