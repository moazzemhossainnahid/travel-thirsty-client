        ...
        <div className=" text-left h-full w-full">
            ...
            <div className="w-full flex items-center justify-center my-12">
                <div className="bg-white shadow rounded py-12 lg:px-28 px-8">
                    <p className="md:text-3xl text-xl font-bold pb-10 leading-7 text-center text-gray-700">Total Users: {data?.length}</p>
                    <div className="">
                        <table class="border-collapse w-full bg-slate-200">
                            ...
                            <tbody>
                                ...
                                {
                                    data?.map((user, index) => <UserDetails key={user._id} user={user} index={index} refetch={refetch} />)
                                }
