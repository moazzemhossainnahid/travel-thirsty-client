    ...
    return (
        ...
        <div className='w-5/6 mx-auto py-20'>
                ...
                <div className="border-b-2 my-20 flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-2/5 p-4 mt-20 md:mt-0 sm:p-6 lg:p-8 bg-white shadow-md">
                        ...
                        <div className="w-full h-fit p-8 mx-2 flex justify-center">
                            <img id="showImage" className="max-w-xs w-32 items-center border-2 rounded shadow " src={user?.photoURL  ? `${user?.photoURL}` : 'https://placeimg.com/80/80/people' } alt="" />
                        </div>
                    ...
                    <div className="w-full md:w-3/5 p-8 bg-white lg:ml-4 shadow-md">
                        <div className="rounded  shadow p-6">
                            <div className="pb-6">
                                ...
                                <div className="flex">
                                    <input disabled id="username" className="border-1  rounded-r px-4 py-2 w-full" type="text" value={user?.displayName ? user?.displayName : ''} />
                                </div>
                            </div>
                            <div className="pb-4">
                            ...
                            <div className="pb-4">
                                ...
                                <input disabled id="phone" className="border-1  rounded-r px-4 py-2 w-full" type="tel" value='+880-123-456-789' />
            ...
            <div class="modal-box relative  bg-success">
                ...
                <input {...register('email')} type="email" placeholder="Enter Your Email" value={ user && user?.email} className="input bg-slate-100 my-2 input-ghost w-full block mx-auto max-w-xs" />
                ...
                <input className='btn px-7 btn-secondary my-5 block mx-auto' type="submit" value="Update" />
                </form> 
            </div>
            </div>
        </div>
