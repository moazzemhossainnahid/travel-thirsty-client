              ...
              <div className="w-full md:w-2/5 p-4 mt-20 md:mt-0 sm:p-6 lg:p-8 bg-white shadow-md">
                <div className="">
                  <span className="text-xl font-semibold block">
                    {user ? `${user?.displayName}'s Profile` : "User Profile"}{" "}
                  </span>
                ...
                <div className="w-full h-fit p-8 mx-2 flex justify-center">
                  <img
                    id="showImage"
                    className="max-w-xs w-32 items-center border-2 rounded shadow "
                    src={
                      user?.photoURL
                        ? `${user?.photoURL}`
                ...
                <div className="flex justify-end py-3">
                  <label
                    for="my-modal-3"
                    className="mt-2 text-md font-bold text-right  text-white bg-gray-700 rounded-full px-5 py-2 hover:bg-gray-800"
                  >
                    Edit
                  </label>
                </div>
            ...
            <div className="modal">
              <div className="modal-box relative  bg-success">
                ...
                <h3 className="text-lg font-bold">
                  Please Update Your Profile Indormation
                </h3>
                <form
                ...
                >
                  ...
                  <input
                    ...
                    className="input bg-slate-100 my-2 input-ghost items-center w-full block mx-auto max-w-xs cursor-pointer border border-gray-300 text-gray-900 focus:outline-none focus:border-transparent text-sm rounded-lg"
                  />
                  <input
