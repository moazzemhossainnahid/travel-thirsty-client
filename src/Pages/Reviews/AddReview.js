            ...
            <div className="bg-gradient-to-l from-secondary to-accent text-left h-full w-full lg:pt-20">
                ...
                <div className="w-full flex items-center justify-center my-12">
                    <div className="bg-white shadow rounded py-12 lg:px-28 px-8">
                        <p className="md:text-3xl text-xl font-bold leading-7 text-center text-gray-700">Please Say Something for This Website</p>
                        <form onSubmit={handleSubmit(handleAddReview)} className="mb-32" action="">

                            <div className="md:flex items-center mt-12">
                                <div className="w-full flex flex-col">
                                    <label className="text-base font-semibold leading-none text-gray-800">Client Name</label>
                            ...
                            <div className="md:flex items-center mt-12">
                                <div className="md:w-72 flex flex-col">
                                    <label className="text-base font-semibold leading-none text-gray-800">Client Image</label>
                                ...
                                <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                                    <label className="text-base font-semibold leading-none text-gray-800">Client Country</label>
                            ...
                            <div>
                                <div className="w-full flex flex-col mt-8">
                                    ...
                                    <textarea {...register('review')} required tabIndex={0} aria-label="leave a message" type="text" className="h-36 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none" placeholder="Please input Review" />
                                </div>
                            </div>
