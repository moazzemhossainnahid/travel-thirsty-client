...
const ContactHeader = () => {
    ...
    return (
        <div className="bg-gradient-to-tr from-purple-400 to-green-700 h-screen w-full bg-cover bg-center">
            <img src="https://www.wallpapertip.com/wmimgs/9-90686_desktop-backgrounds-hd-travel.jpg" alt="" className="h-screen w-full object-cover absolute mix-blend-overlay" />
            <div class="breadcrumbs flex flex-col justify-center items-center h-screen w-full text-white text-2xl font-bold">
                <ul className='flex-row'>
                    ...
                    <li className=''><Link to="/hotel">Hotel</Link></li>
