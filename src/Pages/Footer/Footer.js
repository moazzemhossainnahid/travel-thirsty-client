...
const Footer = () => {
    return (
        ...
        <div class="relative flex justify-start h-fit bg-gray-700 md:justify-center md:items-end ">
            <div class="flex pt-16 md:pt-20 lg:pt-20 xl:pt-24 px-4 md:px-6 xl:px-10 flex-col justify-start items-start md:justify-center md:items-center relative">
                <div class="flex  flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
                    <div class="flex justify-start items-center space-x-4">
                        <div class="cursor-pointer w-20">
                            <img src="https://i.ibb.co/8XnNFJ2/plane-travel-flight-tourism-travel-icon-png-10.png" alt="logo" />
                        </div>
                        <p class="w-60 text-xl xl:text-2xl font-semibold leading-normal text-white">Travel Thirsty</p>
                    </div>
                ...
                <div class="mt-12 flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
                    <p class="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white" >{new Date().getFullYear()} The Travel Company. All Rights Reserved</p>
