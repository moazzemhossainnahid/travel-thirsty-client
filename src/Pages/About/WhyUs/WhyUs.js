...
const WhyUs = () => {
    return (
        <div className='bg-gradient-to-tr from-purple-400 to-green-700 '>
            ...
            <Fade left><h3 className="text-white font-sans text-2xl pt-16">SIMPLY AMAZING PLACES</h3></Fade>
            <Jump><h3 className="text-white font-serif text-5xl lg:text-7xl py-16">Why Choose Us?</h3></Jump>
